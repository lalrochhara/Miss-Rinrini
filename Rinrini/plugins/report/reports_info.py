...
__help__ = (
    ...
    "To report a user, simply reply to his message with @admin or /report; Rinrini will then reply with a message stating that admins have been notified. This message tags all the chat admins; same as if they had been @'ed.\n\n"
    "Note that the report commands do not work when admins use them; or when used to report an admin. Rinrini assumes that admins don't need to report, or be reported!"
)