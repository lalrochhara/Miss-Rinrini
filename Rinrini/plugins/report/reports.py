...
from Rinrini.database.report_mongo import get_report, reports_db
from Rinrini.helper import custom_filter
from Rinrini.helper.chat_status import isUserAdmin, isUserCan

REPORTS_TRUE = ['yes', 'on']
REPORTS_FALSE = ['no', 'off']

@RinriniCli.on_message(custom_filter.command(commands=('reports')))
