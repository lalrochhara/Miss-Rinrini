...
@RinriniCli.on_message(custom_filter.command(commands=('clearall')))
...
@RinriniCli.on_callback_query(filters.create(lambda _, __, query: 'clearallnotes_' in query.data))
async def ClearAllCallback(client: RinriniCli, callback_query: CallbackQuery):
