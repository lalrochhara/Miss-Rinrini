...
COLLECTIONS_DATAS = RinriniDB.list_collection_names()

@RinriniCli.on_message(custom_filter.command(commands=('dbimport')))
async def RinriniImport(client, message):
    ...
    download_path = await RinriniCli.download_media(
    ...
    for collection in COLLECTIONS_NAMES:
        for exportData in data['exports_data']:
            ...
            if not get_col == None:
                ...
                RinriniDB[collection].insert_many(collection_lists)
