...
from Rinrini.database.filters_mongo import get_filter, get_filters_list
from Rinrini.helper import custom_filter
from Rinrini.helper.filters_helper.send_filter_message import SendFilterMessage


@RinriniCli.on_message(filters.all & filters.group, group=8)
