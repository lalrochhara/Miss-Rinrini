...
from Rinrini.helper.chat_status import isBotCan, isUserCan
from Rinrini.helper.get_user import get_text
from Rinrini.plugins.warnings.warn import warn


@RinriniCli.on_message(custom_filter.command(commands=['warn', 'swarn', 'dwarn']))
