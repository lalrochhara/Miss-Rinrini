...
from Rinrini.database.warnings_mongo import reset_all_warns_db
from Rinrini.helper import custom_filter
from Rinrini.helper.chat_status import isUserCreator


@RinriniCli.on_message(custom_filter.command(commands=('resetallwarns')))
...
@RinriniCli.on_callback_query(filters.create(lambda _, __, query: 'resetwarns_' in query.data))
async def resetwarns_callback(client: RinriniCli, callback_query: CallbackQuery):
