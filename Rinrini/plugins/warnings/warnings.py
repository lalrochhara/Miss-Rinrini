...
from Rinrini.database.warnings_mongo import get_warn_mode, warn_limit
...
from Rinrini.plugins.warnings.set_warn_mode import WarnModeMap
...
@RinriniCli.on_message(custom_filter.command(commands=('warnings'), disable=True))
@disable
