...
from Rinrini.database.rules_mongo import set_rules_db
...
@RinriniCli.on_message(custom_filter.command(commands=('resetrules')))
@anonadmin_checker
async def reset_rules(client, message):
    ...
    await message.reply(
        f"He group {html.escape(chat_title)} tana rules siam chu paih fai vek ani!"
    )
