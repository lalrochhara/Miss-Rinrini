...
from Rinrini.database.antiflood_mongo import setflood_db
from Rinrini.helper import custom_filter
from Rinrini.helper.chat_status import CheckAllAdminsStuffs, isBotAdmin


@RinriniCli.on_message(custom_filter.command(commands=('setflood')))
