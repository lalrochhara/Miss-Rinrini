...
from Rinrini.database.antiflood_mongo import (get_antiflood_mode, get_flood,
                                             get_floodlimit)
from Rinrini.helper import custom_filter
from Rinrini.helper.time_checker import time_string_helper


@RinriniCli.on_message(custom_filter.command(commands=('flood')))
