...
@RinriniCli.on_message(custom_filter.command(commands=('goodbye')))
@anonadmin_checker
async def Welcome(client, message):
    ...
    if len(message.command) >= 2:
        ...
        GOODBYE_MESSAGE = (
            ...
            "NOTE: If your group has more than 50 members, it is possible that Rinrini will stop wishing users goodbye - this is a Telegram restriction.\n\n"
