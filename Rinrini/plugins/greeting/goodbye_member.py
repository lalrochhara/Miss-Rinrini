...
from Rinrini.database.welcome_mongo import (DEFAUT_GOODBYE, GetCleanService,
...
from Rinrini.helper.chat_status import isBotCan
...
@RinriniCli.on_message(filters.left_chat_member)
@anonadmin_checker
async def goodbye_member(client, message):
    ...
    if isGoodbye(chat_id):
        ...
        reply_markup = None
        GoodByeMessageSet = await RinriniCli.send_message(
            chat_id=chat_id,
            text=Text,
