...
from Rinrini.database.welcome_mongo import isRuleCaptcha
...
@RinriniCli.on_callback_query(filters.create(lambda _, __, query: 'captcharule_' in query.data))
async def captchaRules(client: RinriniCli, callback_query: CallbackQuery):
