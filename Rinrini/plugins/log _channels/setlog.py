...
from Rinrini.database.log_channels_mongo import set_log_db
...
@RinriniCli.on_message(custom_filter.command(commands=('setlog')))
@anonadmin_checker
async def set_log(client, message):
    ...
    try:
        GetChannelData = await RinriniCli.get_chat_member(
