...
from Rinrini import LOG_CHANNEL, RinriniCli, TELEGRAM_SERVICES_IDs
from Rinrini.database.federation_mongo import new_fed_db
from Rinrini.helper import custom_filter


@RinriniCli.on_message(custom_filter.command(commands=('newfed')))
