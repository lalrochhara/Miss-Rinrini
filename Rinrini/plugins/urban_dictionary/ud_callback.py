...
from Rinrini.plugins.urban_dictionary.get_data import getData


@RinriniCli.on_callback_query(filters.create(lambda _, __, query: 'pagination_keyboard#' in query.data))
async def ud_callback(client: RinriniCli, callback_query: CallbackQuery):
    ...
    await RinriniCli.edit_message_text(
        chat_id=chat_id,
