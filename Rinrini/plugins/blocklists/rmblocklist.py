...
from Rinrini.database.blocklists_mongo import get_blocklist, rmblocklist_db
...
@RinriniCli.on_message(custom_filter.command(commands=['rmblocklist', 'rmblacklist']))
